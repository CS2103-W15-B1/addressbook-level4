...
|`*` |user |update a person |change the entries to the latest details

|`*` |user |download my addressbook |share my addressbook
...
[none]
* 2a. The person is already existing in the addressbook
+
[none]
...
.  Should work on any link:#mainstream-os[mainstream OS] as long as it has link:#Java[Java] `1.8.0_60` or higher installed.
...
.  Should take at most 10 seconds for the application to startup
.  Should take at most 10 seconds to return any results invoked by the user
